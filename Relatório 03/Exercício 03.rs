...
fn imprimir_terminados_em(digito: i32, limite_inferior: i32, limite_superior: i32){
    ...
    let mut numero = limite_inferior;
...
fn main() {
    ...
    let mut digito: i32 = entrada.trim().parse().unwrap_or(0);
    entrada.clear();
    
    println!("Digite o limite inferior:");
    io::stdin().read_line(&mut entrada).expect("Erro ao ler");
    let mut limite_inferior: i32 = entrada.trim().parse().unwrap_or(0);

    entrada.clear();
    println!("Digite o limite superior:");
    io::stdin().read_line(&mut entrada).expect("Erro ao ler");
    let mut limite_superior: i32 = entrada.trim().parse().unwrap_or(0);
